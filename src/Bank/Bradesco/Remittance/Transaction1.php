...
trait Transaction1 {
    ...
    public function extractTransaction1From($line,$data,$pad=true)
    {
        ...
        if($pad){ return Remittance::padLine('TRANSACTION1', $data, $value); }
        return $value;
    ...
    public function transaction1PadLine($data,$value)
    {
        ...
        switch(strtoupper($data)){
            case 'REGISTRO': return str_pad(substr($value, 0, 1), 1, '1', STR_PAD_LEFT); break;
            case 'AGENCIA': return str_pad(substr($value, 0, 5), 5, $pad_replace, STR_PAD_RIGHT); break;
            case 'AGENCIA_DV': return str_pad(substr($value, 0, 1), 1, $pad_replace, STR_PAD_RIGHT); break;
            case 'RAZAO_CONTA': return str_pad(substr($value, 0, 5), 5, $pad_replace, STR_PAD_RIGHT); break;
            case 'CONTA_CORRENTE': return str_pad(substr($value, 0, 7), 7, $pad_replace, STR_PAD_RIGHT); break;
            ...
            case 'SEU_NUM': return str_pad(substr($value, 0, 25), 25, $pad_replace, STR_PAD_RIGHT); break;
            case 'COD_BANCO': return str_pad(substr($value, 0, 3), 3, $pad_replace, STR_PAD_RIGHT); break;
            case 'MULTA': return str_pad(substr($value, 0, 1), 1, '0', STR_PAD_RIGHT); break;
            ...
            case 'RATEIO': return str_pad(substr($value, 0, 1), 1, $pad_replace, STR_PAD_RIGHT); break;
            case 'AVISO_DEBITO': return str_pad(substr($value, 0, 1), 1, $pad_replace, STR_PAD_RIGHT); break;
            ...
            case 'IDENTIFICACAO': return str_pad(substr($value, 0, 1), 1, 'N', STR_PAD_LEFT); break;
            ...
            case 'SACADO_ENDERECO': return str_pad(substr($value, 0, 40), 40, $pad_replace, STR_PAD_RIGHT); break;
            case 'MENSAGEM_1': return str_pad(substr($value, 0, 12), 12, $pad_replace, STR_PAD_RIGHT); break;
            ...
            case 'MENSAGEM_2': return str_pad(substr($value, 0, 60), 60, $pad_replace, STR_PAD_RIGHT); break;
            case 'SEQUENCIAL': return str_pad(substr($value, 0, 6), 6, '0', STR_PAD_LEFT); break;
            case 'NFE': return str_pad(substr($value, 0, 44), 44, '0', STR_PAD_LEFT); break;
            default: return 'Coluna não aceita no extract remessa data: ' . $data;
        }
    }
