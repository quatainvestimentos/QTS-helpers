...
trait Transaction1 {
    ...
    public function padLine($data,$value)
    {
        ...
        switch(strtoupper($data)){
            ...
            case 'NUM_INSCRICAO': return str_pad($value, 14, '0', STR_PAD_LEFT); break;
            case 'ZEROS_1': return str_pad($value, 3, ' ', STR_PAD_RIGHT); break;
            case 'IDENTIFICACAO_EMPRESA': return str_pad($value, 17, ' ', STR_PAD_RIGHT); break;
            case 'NUM_PARTICIPANTE': return str_pad($value, 25, ' ', STR_PAD_RIGHT); break;
            case 'ZEROS_2': return str_pad($value, 8, '0', STR_PAD_LEFT); break;
            case 'NOSSO_NUM': return str_pad($value, 12, ' ', STR_PAD_RIGHT); break;
            case 'BANCO_1': return str_pad($value, 10, '0', STR_PAD_LEFT); break;
            case 'BANCO_2': return str_pad($value, 12, ' ', STR_PAD_RIGHT); break;
            case 'RATEIO': return str_pad($value, 1,  ' ', STR_PAD_RIGHT); break;
            case 'PAGAMENTO_PARCIAL': return str_pad($value, 2, ' ', STR_PAD_RIGHT); break;
            case 'CARTEIRA': return str_pad($value, 1, '0', STR_PAD_LEFT); break;
            case 'IDENTIFICACAO_OCORRENCIA': return str_pad($value, 2, '0', STR_PAD_LEFT); break;
            case 'DATA_OCORRENCIA': return str_pad($value, 6, '0', STR_PAD_LEFT); break;
            case 'NUM_DOCUMENTO': return str_pad($value, 10, ' ', STR_PAD_RIGHT); break;
            case 'TITULO': return str_pad($value, 20, ' ', STR_PAD_RIGHT); break;
            case 'VENCIMENTO': return str_pad($value, 6, '0', STR_PAD_LEFT); break;
            case 'VALOR_TITULO': return str_pad($value, 13, '0', STR_PAD_LEFT); break;
            case 'BANCO_COBRADOR': return str_pad($value, 3, '0', STR_PAD_LEFT); break;
            case 'AGENCIA_COBRADORA': return str_pad($value, 5, '0', STR_PAD_LEFT); break;
            case 'ESPECIE': return str_pad($value, 2, ' ', STR_PAD_RIGHT); break;
            case 'DESPESAS_1': return str_pad($value, 13, '0', STR_PAD_LEFT); break;
            case 'DESPESAS_2': return str_pad($value, 10, '0', STR_PAD_LEFT); break;
            case 'JUROS': return str_pad($value, 13, '0', STR_PAD_LEFT); break;
            case 'IOF': return str_pad($value, 13, '0', STR_PAD_LEFT); break;
            case 'ABATIMENTO': return str_pad($value, 13, '0', STR_PAD_LEFT); break;
            case 'DESCONTO': return str_pad($value, 13, '0', STR_PAD_LEFT); break;
            case 'VALOR_PAGO': return str_pad($value, 13, '0', STR_PAD_LEFT); break;
            case 'JUROS_MORA': return str_pad($value, 13, '0', STR_PAD_LEFT); break;
            case 'OUTROS_CREDITOS': return str_pad($value, 13, '0', STR_PAD_LEFT); break;
            case 'BRANCOS_1': return str_pad($value, 2, ' ', STR_PAD_RIGHT); break;
            case 'MOTIVO_OCORRENCIA': return str_pad($value, 1, ' ', STR_PAD_RIGHT); break;
            case 'DATA_CREDITO':return str_pad($value, 6, '0', STR_PAD_LEFT); break;
            case 'ORIGEM_PAGAMENTO': return str_pad($value, 3, '0', STR_PAD_LEFT); break;
            case 'BRANCOS_2': return str_pad($value, 10, ' ', STR_PAD_RIGHT); break;
            case 'CHEQUE_BRADESCO': return str_pad($value, 4, '0', STR_PAD_LEFT); break;
            case 'MOTIVO_REJEICAO': return str_pad($value, 10, '0', STR_PAD_LEFT); break;
            case 'BRANCOS_3': return str_pad($value, 40, ' ', STR_PAD_RIGHT); break;
            case 'NUM_CARTORIO': return str_pad($value, 2, '0', STR_PAD_LEFT); break;
            case 'NUM_PROTOCOLO': return str_pad($value, 10, ' ', STR_PAD_RIGHT); break;
            case 'BRANCOS_4': return str_pad($value, 14, '0', STR_PAD_LEFT); break;
