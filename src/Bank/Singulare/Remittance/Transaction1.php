...
trait Transaction1 {
    ...
    public function padLine($data,$value)
    {
        ...
        switch(strtoupper($data)){
            ...
            case 'DEBITO_AUTOMATICO': return str_pad($value, 19, ' ', STR_PAD_RIGHT); break;
            case 'COOBRIGACAO': return str_pad($value, 2, '0', STR_PAD_LEFT); break;
            case 'CARACTERISTICA': return str_pad($value, 2, '0', STR_PAD_LEFT); break;
            case 'MODALIDADE': return str_pad($value, 4, '0', STR_PAD_LEFT); break;
            case 'NATUREZA': return str_pad($value, 2, '0', STR_PAD_LEFT); break;
            case 'ORIGEM': return str_pad($value, 4, '0', STR_PAD_LEFT); break;
            case 'CLASSE_RISCO': return str_pad($value, 2, ' ', STR_PAD_RIGHT); break;
            case 'ZEROS_1': return str_pad($value, 1, '0', STR_PAD_LEFT); break;
            case 'NUM_CONTROLE_PARTICIPANTE': return str_pad($value, 25, ' ', STR_PAD_RIGHT); break;
            case 'NUM_BANCO': return str_pad($value, 3, '0', STR_PAD_LEFT); break;
            case 'ZEROS_2': return str_pad($value, 5, '0', STR_PAD_LEFT); break;
            case 'IDENTIFICACAO': return str_pad($value, 11, '0', STR_PAD_LEFT); break;
            case 'NOSSO_NUM_DV': return str_pad($value, 1, ' ', STR_PAD_RIGHT); break;
            case 'VALOR_PAGO': return str_pad($value, 10, '0', STR_PAD_LEFT); break;
            case 'EMISSAO_COBRANCA': return str_pad($value, 1, '0', STR_PAD_LEFT); break;
            case 'EMISSAO_DEBITO_AUTOMATICO': return str_pad($value, 1, ' ', STR_PAD_RIGHT); break;
            case 'LIQUIDACAO': return str_pad($value, 6, '0', STR_PAD_LEFT); break;
            case 'OPERACAO_BANCO': return str_pad($value, 4, ' ', STR_PAD_RIGHT); break;
            case 'RATEIO': return str_pad($value, 1, ' ', STR_PAD_RIGHT); break;
            case 'AVISO_DEBITO': return str_pad($value, 1, '0', STR_PAD_LEFT); break;
            case 'BRANCO': return str_pad($value, 2, ' ', STR_PAD_RIGHT); break;
            case 'OCORRENCIA': return str_pad($value, 2, '0', STR_PAD_LEFT); break;
            case 'NUM_DOCUMENTO': return str_pad($value, 10, ' ', STR_PAD_RIGHT); break;
            ...
            case 'IDENTIFICACAO_OPERACAO': return str_pad($value, 1, ' ', STR_PAD_RIGHT); break;
            case 'EMISSAO': return str_pad($value, 6, '0', STR_PAD_LEFT); break;
            case 'INSTRUCAO_1': return str_pad($value, 2, '0', STR_PAD_LEFT); break;
            case 'INSTRUCAO_2':return str_pad($value, 1, '0', STR_PAD_LEFT); break;
            case 'TIPO_INSCRICAO': return str_pad($value, 2, ' ', STR_PAD_RIGHT); break;
            case 'ZEROS_2': return str_pad($value, 11, ' ', STR_PAD_RIGHT); break;
            case 'NUM_TERMO_CESSAO': return str_pad($value, 19, ' ', STR_PAD_RIGHT); break;
            case 'VALOR_PARCELA': return str_pad($value, 13, '0', STR_PAD_LEFT); break;
            case 'VALOR_ABATIMENTO': return str_pad($value, 13, '0', STR_PAD_LEFT); break;
            case 'IDENTIFICACAO_TIPO_INSCRICAO': return str_pad($value, 2, '0', STR_PAD_LEFT); break;
            case 'SACADO_INSCRICAO': return str_pad($value, 14, '0', STR_PAD_LEFT); break;
            case 'SACADO_NOME': return str_pad($value, 40, ' ', STR_PAD_RIGHT); break;
            case 'SACADO_ENDERECO': return str_pad($value, 40, ' ', STR_PAD_RIGHT); break;
            case 'NFE_NUMERO': return str_pad($value, 9, ' ', STR_PAD_RIGHT); break;
            case 'NFE_SERIE': return str_pad($value, 3, ' ', STR_PAD_RIGHT); break;
            case 'SACADO_CEP': return str_pad($value, 8, '0', STR_PAD_LEFT); break;
            case 'CEDENTE': return str_pad($value, 60, ' ', STR_PAD_RIGHT); break;
            case 'NFE': return str_pad($value, 44, ' ', STR_PAD_RIGHT); break;
